...
env_name = "l2rpn_neurips_2020_track1_small_val"
SCOREUSED = ScoreL2RPN2020

agent_name = name
nb_scenario = 10
nb_process_stats = 1
load_path = "./FirstAgent.tflite"
...
if __name__ == "__main__":
    ...
    print(
        f"The agent \"{agent_name}\" beats \"do nothing\" baseline in {best_than_dn} out of {len(dn_ts_survived)} episodes")
    ...
    print(
        f"The agent \"{agent_name}\" beats \"reco powerline\" baseline in {best_than_reco} out of {len(reco_ts_survived)} episodes")
